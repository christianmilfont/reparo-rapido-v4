    ...
    return (
        <nav className="flex">
            <ul className="flex gap-6">
                ...
                <li>
                    <Link href={'/produtos/cad-produtos'} className="flex items-center text-[#4a90e2] hover:text-white bg-white hover:bg-[#4a90e2] py-2 px-4 rounded-lg transition-all duration-300 ease-in-out shadow">
